...
export default function Banner() {
  return (
    <div className="relative bg-[linear-gradient(180deg,#EEF0F5_0%,#F8F9FC_100%)] pt-28 pb-40 text-center px-4">
      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <h1 className="text-[40px] md:text-[56px] font-bold leading-[1.2] text-gray-900">
          ...
          <span className="bg-[linear-gradient(180deg,#632EE3_0%,#9F62F2_100%)] bg-clip-text text-transparent">
            Productive <span className= "text-[40px] md:text-[56px] font-bold leading-[1.2] text-gray-900"> Apps</span>
          </span>
        </h1>
      ...
      {/* STATS SECTION */}
      <div className="absolute left-1/2 -translate-x-1/2 bottom-0 w-full max-w-[1500px] px-4 translate-y-1/2 pb-[180px] pt-[65px] ">
        <div className="bg-[linear-gradient(90deg,#632EE3_0%,#9F62F2_100%)] rounded-xl py-10 text-white shadow-xl">
